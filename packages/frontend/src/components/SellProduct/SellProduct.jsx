...
export default function SellProduct() {
  ...
  async function createProduct() {
    try {
      ...
      const item = { ...product, images, price: ethers.utils.parseEther(product.price) }
      ...
      <div className="m-auto flex flex-col w-full sm:max-w-[633px]">
        ...
        <div className="relative mb-12">
          <input
            ...
            className="outline-none px-4 py-2 font-medium rounded-[10px] w-full dark:bg-[#363952] text-black"
          ></input>
        </div>
        <label
          className="block text-[17px] font-medium mb-4 text-white"
        ...
        <div className="relative mb-12">
          <div className="flex flex-col w-full">
            ...
            <input
              ...
              className="outline-none font-medium px-4 py-2 w-full h-[44px] rounded-[10px] dark:bg-[#363952] text-black"
              type="number"
        ...
        <textarea
          className="outline-none p-6 w-full h-[206px] rounded-[20px] mb-12 dark:bg-[#363952] text-black"
        ...
        <button disabled={!isConnected} onClick={createProduct} className="w-full ml-auto px-12 py-2 rounded-[10px] bg-gradient-to-r from-violet-500 to-fuchsia-500 text-white text-[18px] font-semibold hover:opacity-90 disabled:bg-[#595B73] disabled:pointer-events-none sm:min-w-[230px] sm:w-auto">
